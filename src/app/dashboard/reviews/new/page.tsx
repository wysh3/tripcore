...
export default function NewReviewPage() {
  ...
  useEffect(() => {
    async function fetchContext() {
      const data = await getReviewFormContext();
      setContext(data);
    }
    fetchContext();
  }, []);
    ...
    <div className="space-y-6 max-w-2xl mx-auto font-sans pb-20">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Add New Review</h1>
            <p className="text-gray-500 text-sm mt-1">Manually enter a customer review or testimonial.</p>
          </div>
        </div>
